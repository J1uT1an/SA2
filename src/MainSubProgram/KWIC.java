...
public class KWIC {
	...
	public static void main(String[] args) {
		...
		KWIC kwic = new KWIC();
		kwic.input("C:\\code-program\\Java\\SoftwareArchitecture\\KWIC\\src\\MyKWIC\\input.txt");
		kwic.shift();
		kwic.alphabetizer();
		kwic.output("C:\\code-program\\Java\\SoftwareArchitecture\\KWIC\\src\\MyKWIC\\output.txt");
	}
